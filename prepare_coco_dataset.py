...
if __name__ == "__main__":
    ...
    for im_path in tqdm(dataset.image_paths):
        ...
        for obj in obj_p_labels:
            txt, bbox, score, seg_poly = obj
            txt = txt.lower()
            if txt not in obj_info:
                obj_info[txt] = []
            obj_info[txt].append((bbox, score, seg_poly))
        ...
        for cls in cates:
            ...
            if not cls in categories_to_id:
                ...
                category_curr_id += 1
            box, score, seg_mask = random.choice(obj_info[cls])
            ...
            if len(seg_mask)>0:
                ...
                anno_item['segmentation'] = seg_mask
    ...
    with open(args.output_path, 'w') as f:
        ...
        print("COCO style data saved at ", args.output_path)
